...
namespace ExtendedSegmentedTabControl.Controls
{
    ...
    {
        public static readonly BindableProperty ItemSelectedProperty = BindableProperty.Create(nameof(ItemSelected), typeof(object),
            typeof(SegmentedControl), null, BindingMode.TwoWay, propertyChanged: (bindable, oldValue, newValue) => OnItemSelectedChanged(bindable, oldValue, newValue));
       
        public static readonly BindableProperty ItemsSourceProperty = BindableProperty.Create(nameof(ItemsSource),
            typeof(IEnumerable), typeof(SegmentedControl), new List<object>(), propertyChanged: (bindable, oldValue, newValue) => OnItemsSourceChanged(bindable, oldValue, newValue));
        
        public static readonly BindableProperty SelectionIndicatorProperty = BindableProperty.Create(nameof(SelectionIndicator), 
            typeof(string), typeof(SegmentedControl), string.Empty);
       
        public static readonly BindableProperty ItemTemplateProperty = BindableProperty.Create(nameof(ItemTemplate),
            typeof(DataTemplate), typeof(SegmentedControl), default(DataTemplate));
       
        public static readonly BindableProperty SelectedItemChangedCommandProperty = BindableProperty.Create(nameof(SelectedItemChangedCommand),
            typeof(Command<object>), typeof(SegmentedControl), default(Command<object>), BindingMode.TwoWay, null, SelectedItemChangedCommandPropertyChanged);
